 ...
 * @author juliano
 */
public class frmLCidades extends javax.swing.JFrame {

    /**
     * Creates new form frmLCidades
     */
    public frmLCidades() {
        initComponents();
    }
    ...
    public void filterGrid(String _cid_descricao) {
        daoCidade = new Pub_cidadeDAO();
        DefaultTableModel dados = (DefaultTableModel) jTable1.getModel();
        dados.setNumRows(0);

        daoCidade.findDesc(_cid_descricao).stream().forEach((t) -> {
            dados.addRow(new String[]{"" + t.getCid_codigo(), "" + t.getCid_descricao(), "" + t.getCid_cep(), t.getEst_codigo().getEst_sigla()});
        });
    }
    ...
    public void refreshGrid() {
        ...
        daoCidade.findAll().stream().forEach((t) -> {
            dados.addRow(new String[]{"" + t.getCid_codigo(), "" + t.getCid_descricao(), "" + t.getCid_cep(), t.getEst_codigo().getEst_sigla()});
        });
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "cid_codigo", "Descrição", "CEP", "Sigla (UF)"
            }
        ) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        frmMCidades frm = new frmMCidades(0);
        frm.setVisible(true);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (_linha > -1) {
            int _cid_codigo = Integer.parseInt((String) jTable1.getValueAt(_linha, 0));
            frmMCidades frm = new frmMCidades(_cid_codigo);
            frm.setVisible(true);
        } else {
        ...
        if (_linha > -1) {
            try {
                ...
                if (operacao == JOptionPane.YES_OPTION) {
                    int _cid_codigo = Integer.parseInt((String) jTable1.getValueAt(_linha, 0));
                    pub_cidade = daoCidade.findById(_cid_codigo);
                    daoCidade.delete(pub_cidade);
                }
            } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmLCidades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmLCidades().setVisible(true);
            }
        });
    }
