...
public class Pro_categoriaDAO {
    ...
    public List<Pro_categoria> findDesc(String _cat_descricao) {
        return session.createQuery("from Pro_categoria where cat_descricao like '%" + _cat_descricao + "%' order by cat_descricao").list();
    }
}
